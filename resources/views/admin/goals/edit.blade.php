...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">تعديل الهدف</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <h4 class="header-title m-t-0 m-b-30">بيانات الهدف: {{$goal->ar_name}}</h4>

                <div class="row">

                    {!!Form::model($goal , ['route' => ['admin.goals.update' ,  $goal->id] , 'method' => 'PATCH' ,'files'=>true]) !!}
