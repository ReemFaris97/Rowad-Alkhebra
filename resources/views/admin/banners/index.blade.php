                ...
                <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($banners as $row)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.banners.edit',$row->id)}}" class="label label-warning">تعديل</a>
                                <a href="#"  onclick="Delete({{$row->id}})"  class="label label-danger" >حذف</a>
                                {!!Form::open( ['route' => ['admin.banners.destroy',$row->id] ,'id'=>'delete-form'.$row->id, 'method' => 'Delete']) !!}
                                {!!Form::close() !!}
