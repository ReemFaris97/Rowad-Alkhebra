...
@section('title','تعديل الهيكل التنظيمى')
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">تعديل الهيكل التنظيمى </h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <h4 class="header-title m-t-0 m-b-30">بيانات الهيكل التنظيمى: {{$structure->ar_name}}</h4>

                <div class="row">

                    {!!Form::model($structure , ['route' => ['admin.structures.update' ,  $structure->id] , 'method' => 'PATCH' ,'files'=>true]) !!}
