...
@section('title','إدارة الهياكل التنظمية')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="btn-group pull-right m-t-15">
                <a href="{{route('admin.structures.create')}}" class="btn btn-custom dropdown-toggle waves-effect waves-light">
                   إضافة هيكل تنظيمى جديد
                    <span class="m-l-5"><i class="fa fa-plus"></i></span>
                </a>
            </div>

            <h4 class="page-title">الهياكل التنظمية</h4>
        </div>
    </div>
    <!--End Page-Title -->
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <h4 class="header-title m-t-0 m-b-30">كل الهياكل التنظمية</h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($structures as $row)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.structures.edit',$row->id)}}" class="label label-warning">تعديل</a>
                                <a href="#"  onclick="Delete({{$row->id}})"  class="label label-danger" >حذف</a>
                                {!!Form::open( ['route' => ['admin.structures.destroy',$row->id] ,'id'=>'delete-form'.$row->id, 'method' => 'Delete']) !!}
                                {!!Form::close() !!}
                            </td>
                        </tr>
                    @endforeach
