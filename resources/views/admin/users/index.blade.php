    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="btn-group pull-right m-t-15">
                <a href="{{route('admin.users.create')}}" class="btn btn-custom dropdown-toggle waves-effect waves-light">
                   إضافة مستخدم جديد
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($users as $row)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.users.edit',$row->id)}}" class="label label-warning">تعديل</a>
