...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">معرض الصور</h4>
        </div>
    </div>
    <!--End Page-Title -->
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <h4 class="header-title m-t-0 m-b-30">كل الصور</h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($galleries as $row)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.galleries.edit',$row->id)}}" class="label label-warning">تعديل</a>
                                <a href="#"  onclick="Delete({{$row->id}})"  class="label label-danger" >حذف</a>
                                {!!Form::open( ['route' => ['admin.galleries.destroy',$row->id] ,'id'=>'delete-form'.$row->id, 'method' => 'Delete']) !!}
                                {!!Form::close() !!}
                            </td>
                        </tr>
                    @endforeach
