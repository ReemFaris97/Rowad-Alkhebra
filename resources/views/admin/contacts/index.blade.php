    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            {{--<div class="btn-group pull-right m-t-15">--}}
                {{--<a href="{{route('admin.services.create')}}" class="btn btn-custom dropdown-toggle waves-effect waves-light">--}}
                   {{--إضافة خدمة جديد--}}
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <h4 class="header-title m-t-0 m-b-30">كل رسائل التواصل</h4>
...
@section('scripts')
    ...
    <script>
        ...
        $('body').on('click', '.removeElement', function () {
            ...
            swal({
                    title: "هل انت متأكد؟",
                    text: 'هل تريد حذف رسالة التواصل فعلا ؟',
                    type: "error",
