...
<div class="col-sm-12 col-xs-12  pull-right">
    <div class="form-group form-float">
        <label class="form-label"> اسم الخدمة باللغة العربية</label>
        <div class="form-line">
            {!! Form::text("ar_name",null,['class'=>'form-control','placeholder'=>'  اسم الخدمة باللغة العربية'])!!}
        </div>
    </div>
</div>
...
<div class="col-sm-12 col-xs-12  pull-right">
    <div class="form-group form-float">
        <label class="form-label">اسم الخدمة باللغة  الانجليزية</label>
        <div class="form-line">
            {!! Form::text("en_name",null,['class'=>'form-control','placeholder'=>' اسم الخدمة باللغة الانجليزية'])!!}
        </div>
    </div>
</div>
...
@if( isset($service))
    ...
    <div class="form-group col-xs-12 col-md-6 form-float">
        <label>الصورة: </label>
        <img src="{{getimg($service->image)}}" style="width:100px; height:100px">
    </div>
