...
@section('content')
    ...
    <section class="header sm-head">
        ...
        <!--Start Carousel-->
        <div class="crumbs">
            <h4> <a href="index.html">الرئيسية</a> /  خدماتنا </h4>
        </div>
        <!--End Carousel-->
                                    ...
                                    <div class="pane-graphic">
                                        ...
                                        <div class="field field-name-field-cta-graphic field-type-image field-label-hidden">
                                            <div class="field-items">
                                                <div class="field-item even"><img src="img/task1.png" alt="Drupal for developers" style="transform: matrix(1, 0, 0, 1, 0, 0);"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="column-content-region-inner tertiary-first-inner">
                                <div class="panel-pane pane-fieldable-panels-pane pane-vid-4476 d-persona d-persona-developers pane-bundle-cta pane-fpid-418">
                                    ...
                                    <div class="pane-graphic">
                                        ...
                                        <div class="field field-name-field-cta-graphic field-type-image field-label-hidden">
                                            <div class="field-items">
                                                <div class="field-item even"><img src="img/task2.png" alt="Drupal for developers" style="transform: matrix(1, 0, 0, 1, 0, 0);"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="column-content-region-inner tertiary-first-inner">
                                <div class="panel-pane pane-fieldable-panels-pane pane-vid-4476 d-persona d-persona-developers pane-bundle-cta pane-fpid-418">
                                    ...
                                    <div class="pane-graphic">
                                        ...
                                        <div class="field field-name-field-cta-graphic field-type-image field-label-hidden">
                                            <div class="field-items">
                                                <div class="field-item even"><img src="img/task3.png" alt="Drupal for developers" style="transform: matrix(1, 0, 0, 1, 0, 0);"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="column-content-region-inner tertiary-first-inner">
                                <div class="panel-pane pane-fieldable-panels-pane pane-vid-4476 d-persona d-persona-developers pane-bundle-cta pane-fpid-418">
                                    ...
                                    <div class="pane-graphic">
                                        ...
                                        <div class="field field-name-field-cta-graphic field-type-image field-label-hidden">
                                            <div class="field-items">
                                                <div class="field-item even"><img src="img/task4.png" alt="Drupal for developers" style="transform: matrix(1, 0, 0, 1, 0, 0);"></div>
                                            </div>
                                        </div>
